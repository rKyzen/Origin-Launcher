...
import app.lawnchair.setup.OriginSetupActivity
...
class LawnchairLauncher : QuickstepLauncher() {
    ...
    override fun onResume() {
        ...
        val prefs2 = PreferenceManager2.getInstance(this)
        if (!prefs2.firstRunCompleted.firstBlocking()) {
            startActivity(OriginSetupActivity.createIntent(this))
        }
