...
fun Preferences(
    ...
    val startingRoute = startDestination ?: Root

    val useTwoPane = isExpandedScreen

    var currentTopRoute by remember { mutableStateOf(startingRoute as PreferenceRootRoute) }
