...
import app.lawnchair.origin.OriginModeApplier;
...
public class DeviceProfile {
    ...
    DeviceProfile(Context context, InvariantDeviceProfile inv, Info info,
        ...
        // Apply Origin Mode duration scaling
        try {
            OriginModeConfig originConfig = OriginModeManager.getInstance(context).currentConfig();
            allAppsOpenDuration = (int) (allAppsOpenDuration * originConfig.getAllAppsOpenDurationScale());
            allAppsCloseDuration = (int) (allAppsCloseDuration * originConfig.getAllAppsCloseDurationScale());
        } catch (Exception e) {
            // Fall back to defaults if OriginModeManager not yet available
        }
